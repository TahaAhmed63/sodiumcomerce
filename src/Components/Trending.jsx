...
const Trending = () => {
  ...
  return (
    <div className="flex h-screen min-h-screen relative overflow-hidden">
      ...
      >
        {products.map((product, index) => (
          ...
          >
            <Image src={product?.modelImage} alt={product.name} className="w-full" />
          </SwiperSlide>
        ))}
      </Swiper>

      {/* Right Swiper for Product Details */}
      <div className="flex flex-1 mt-10 pt-10">
        <Swiper
          ...
          autoplay={true}
          className="product-slider w-1/2"
          pagination={{
            type: "bullets",
            clickable: true,
            horizontalClass: "pagination-horizontal", // custom class for horizontal pagination
          }}
        >
